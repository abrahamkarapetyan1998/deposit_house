                                ...
                                '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            ...
                                            '</label>'+
                                            '<input type="text" id="sizeName" name="size[]" class="input-field unrequire" placeholder="Size Name" required="required">'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Qty :'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_qty[]" class="input-field unrequire" placeholder="Size Qty" value="1" min="0" required="required" >'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Price :'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_price[]" class="input-field unrequire" placeholder="Size Price" value="0" min="0" required="required">'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'
                            +'');

                            $(document).on('input', '#sizeName', function (){
                                $(this).val(this.value = this.value.replace(/[,]/g, '').replace(/(\..*?)\..*/g, '$1'));
                               })
});
                                    ...
                                    '<div  class="row">'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            ...
                                            'Size Name :'+
                                                '<span>(eg. S,M,L,XL,XXL,3XL,4XL)</span>'+
                                            '</label>'+
                                            '<input type="text" name="size[]" class="input-field" placeholder="'+langg.lang649+'" required="required">'+
                                            '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Qty :'+
                                            '<span>(Number of quantity of this size)</span>'+
                                            '</label>'+
                                            '<input type="number" name="size_qty[]" class="input-field" placeholder="'+langg.lang651+'" value="1" min="0" required="required">'+
                                            '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Price :'+
                                            '<span>(This price will be added with base price)</span>'+
                                            '</label>'+
                                            '<input type="number" name="size_price[]" class="input-field" placeholder="'+langg.lang653+'" value="0" min="0" required="required">'+
                                            '</div>'+
                                    '</div>'+
                                '</div>'
                            +'');
