...
$(".categories_menu_inner > ul > li.dropdown_list .link-area > a").each(function(){
    ...
    $('#example').DataTable({
        ...
        "info": false,
        "language": {
            "lengthMenu": langg.lengthMenu + "_MENU_",
            "zeroRecords": langg.zeroRecords,
            "info": langg.info + "_START_ "+ langg.to+" _END_ "+ langg.of+" _TOTAL_" + langg.entries ,
            "search": langg.search,
            "infoEmpty": langg.infoEmpty,
            "paginate": {
                "first":      langg.first,
                "last":       langg.last,
                "next":       langg.next,
                "previous":   langg.previous
            },
        },
