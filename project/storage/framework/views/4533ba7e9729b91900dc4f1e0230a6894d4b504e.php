<li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
            ...
            <li>
                <a href="<?php echo e(route('admin-order-pending','pending')); ?>"> <?php echo e(__('Pending Orders')); ?></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-order-processing','processing')); ?>"> <?php echo e(__('Processing Orders')); ?></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-order-completed','completed')); ?>"> <?php echo e(__('Completed Orders')); ?></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-order-declined','declined')); ?>"> <?php echo e(__('Declined Orders')); ?></a>
            </li>
    ...
    <li>
        <a href="<?php echo e(route('admin-country-index')); ?>" class=" wave-effect"><i class="fas fa-flag"></i><?php echo e(__('Manage Country')); ?></a>
    </li>
    <li>
    ...
    <li>
        ...
        <?php endif; ?>" id="menu5" data-parent="#accordion" >
                ...
                <li class="<?php if(request()->is('admin/category/serial/manage')): ?> active <?php endif; ?>">
                    <a href="<?php echo e(route('admin-category-serial-index')); ?>"><span><?php echo e(__('Drag & Drop Category')); ?></span></a>
                </li>
        </ul>
    </li>
    ...
    <li>
        <a href="#sms" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-at"></i><?php echo e(__('Sms Settings')); ?>

        </a>
        <ul class="collapse list-unstyled" id="sms" data-parent="#accordion">
            <li><a href="<?php echo e(route('admin-sms-index')); ?>"><span><?php echo e(__('SMS Template')); ?></span></a></li>
            <li><a href="<?php echo e(route('admin-sms-config')); ?>"><span><?php echo e(__('SMS Configurations')); ?></span></a></li>
        </ul>
    </li>
    <li>
        ...
        <ul class="collapse list-unstyled" id="payments" data-parent="#accordion">
            ...
            <li><a href="<?php echo e(route('admin-withdraw-method-index')); ?>"><span><?php echo e(__('Withdraw Method')); ?></span></a></li>
...
<?php /**PATH C:\OpenServer\domains\upwork_first\project\resources\views/includes/admin/roles/super.blade.php ENDPATH**/ ?>