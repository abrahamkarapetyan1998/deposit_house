			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 remove-padding d-none d-lg-block">
						<div class="aside">
							<a class="banner-effect mb-10" href="<?php echo e(isset($sideBanner->best_seller_banner) ? $sideBanner->best_seller_banner_link : ''); ?>">
								<img src="<?php echo e(isset($sideBanner->best_seller_banner) ? asset('assets/images/test/'.$sideBanner->best_seller_banner) : ''); ?>" alt="">
							</a>
							<a class="banner-effect" href="<?php echo e(isset($sideBanner->best_seller_banner_link1) ? $sideBanner->best_seller_banner_link1 : ''); ?>">
								<img src="<?php echo e(isset($sideBanner->best_seller_banner_link1) ? asset('assets/images/test/'.$sideBanner->best_seller_banner1) : ''); ?>" alt="">
							</a>
						</div>
					</div>
				</div>
		...
		<section class="categori-item clothing-and-Apparel-Area">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 remove-padding d-none d-lg-block">
						<div class="aside">
							<a class="banner-effect mb-10" href="<?php echo e(isset($sideBanner->big_save_banner_link) ? $sideBanner->big_save_banner_link : ''); ?>">
								<img src="<?php echo e(isset($sideBanner->big_save_banner_link) ? asset('assets/images/test/'.$sideBanner->big_save_banner) : ''); ?>" alt="">
							</a>
							<a class="banner-effect" href="<?php echo e(isset($sideBanner->big_save_banner_link1)  ? $sideBanner->big_save_banner_link1 : ''); ?>">
								<img src="<?php echo e(isset($sideBanner->big_save_banner_link1) ? asset('assets/images/test/'.$sideBanner->big_save_banner1) : ''); ?>" alt="">
							</a>
						</div>
					</div>
				</div>
	...
	<!-- main -->
	<script src="<?php echo e(asset('assets/front/js/mainextra.js')); ?>"></script><?php /**PATH C:\OpenServer\domains\upwork_first\project\resources\views/front/extraindex.blade.php ENDPATH**/ ?>