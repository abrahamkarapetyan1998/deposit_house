			...
			<?php echo $__env->make('includes.form-error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					...
					<div class="checkout-area">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="pills-step2" role="tabpanel" aria-labelledby="pills-step2-tab">
								...
								<div class="content-box">
									...
									<div class="content">
										...
										<?php $__currentLoopData = $new_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<div class="order-area">
												...
												<div class="order-item">
													...
													<div class="product-content">
														...
														<div class="unit-price">
															...
															<p><?php echo e(App\Models\Product::convertPrice($product['item_price'])); ?></p>
											...
											<div class="row p-5">
												...
												<div class="col-md-6">
													...
													<p><b><?php echo e(__('Shipping Name')); ?> :</b> <?php echo e($shipping_weghts[$key]['shop_name']); ?></p>



													<?php if($shipping_weghts[$key]['weght'] != 0): ?>

													<!--<p><b><?php echo e(__('Weght')); ?> :</b> <?php echo e($shipping_weghts[$key]['weght']); ?>  (<?php echo e(__('KG')); ?>)</p>-->

													<b><?php echo e(__('Shipping Cost')); ?> :</b> <small>(<?php echo e($shipping_charge_info[$key]['title']); ?>)</small> : <strong><?php echo e(App\Models\Product::convertPrice($shipping_charge_info[$key]['price'])); ?></strong>
											...
											<div class="payment-information">
												...
												<div class="row">
													...
													<div class="col-lg-12">
														...
														<?php if($gs->cpay_check == 1): ?>

															<a class="nav-link payment" data-val="" data-show="no" data-form="<?php echo e(route('cpay.payment.submit')); ?>" data-href="<?php echo e(route('front.load.payment',['slug1' => 'cpay','slug2' => 0])); ?>" id="v-pills-tab21-tab" data-toggle="pill" href="#v-pills-tab21" role="tab" aria-controls="v-pills-tab21" aria-selected="false">
													...
													<div class="col-lg-12">
													  ...
													  <div class="pay-area d-none">
														...
														<div class="tab-content" id="v-pills-tabContent">
															...
															<div class="tab-pane fade" id="v-pills-tab21" role="tabpanel" aria-labelledby="v-pills-tab21-tab">
                            ...
                            <input type="hidden" id="shipping-cost" name="shipping_cost" value="<?php echo e($shipping_total_cost); ?>">
                            ...
                            <input type="hidden" name="vendor_ship_ids" value="<?php echo e($all_vendor_shipp); ?>">
					...
					<div class="right-area">
						...
						<ul class="order-list">
							...
							<P>
								...
								<b class="cart-total"><?php echo e(Session::has('cart') ? App\Models\Product::convertPrice(Session::get('cart')->totalPrice) : '0.00'); ?></b>
							...
							<P>
								...
								<b><?php echo e(App\Models\Product::convertPrice($shipping_total_cost)); ?></b>

							</P>

							</li>

							<?php if($discount_whole_sell != 0): ?>
							...
							<li>
								...
								<P>
									...
									<b class=""> <?php echo e($curr->sign); ?><?php echo e($discount_whole_sell); ?> </b>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\upwork_first\project\resources\views/front/checkout.blade.php ENDPATH**/ ?>