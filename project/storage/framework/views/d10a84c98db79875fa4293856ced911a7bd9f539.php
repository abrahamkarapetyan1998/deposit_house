...
<hr>
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            <div class="action-list">
                                <select class="process select droplinks <?php echo e($gs->cpay_check == 1 ? 'drop-success' : 'drop-danger'); ?>">
                                  <option data-val="1" value="<?php echo e(route('admin-gs-cpay',1)); ?>" <?php echo e($gs->cpay_check == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
                                  <option data-val="0" value="<?php echo e(route('admin-gs-cpay',0)); ?>" <?php echo e($gs->cpay_check == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
                                </select>
                              </div>
                        </div>
                      </div>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-3">
                          <div class="left-area">
                              <h4 class="heading"><?php echo e(__('Merchant ID')); ?> *
                                </h4>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <input type="text" class="input-field" placeholder="<?php echo e(__('Merchant ID')); ?>" name="merchant_key" value="<?php echo e($gs->merchant_key); ?>" required="">
                        </div>
                      </div>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-3">
                          <div class="left-area">
                              <h4 class="heading"><?php echo e(__('Merchant Name')); ?> *
                                </h4>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <input type="text" class="input-field" placeholder="<?php echo e(__('Merchant Name')); ?>" name="merchant_name" value="<?php echo e($gs->merchant_name); ?>" required="">
                        </div>
                      </div>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-3">
                          <div class="left-area">
                              <h4 class="heading"><?php echo e(__('MD5 Password')); ?> *
                                </h4>
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <input type="text" class="input-field" placeholder="<?php echo e(__('MD5 Password')); ?>" name="cpay_password" value="<?php echo e($gs->cpay_password); ?>" required="">
                        </div>
                      </div>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-3">
                          <div class="left-area">
                              <h4 class="heading"><?php echo e(__('Cpay Text')); ?> *</h4>

                          </div>
                        </div>
                        <div class="col-lg-6">
                          <textarea class="input-field" name="cpay_text" placeholder="<?php echo e(__('Cpay Text')); ?>"><?php echo e($gs->cpay_text); ?></textarea>
                        </div>
                      </div>
<hr>
...
<hr>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="col-lg-6">
                            ...
                            <input type="text" class="input-field" placeholder="<?php echo e(__('Withdraw Fee')); ?>" name="withdraw_fee" value="<?php echo e(round($gs->withdraw_fee * $curr->value,2)); ?>" required="">
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\upwork_first\project\resources\views/admin/generalsetting/paymentsinfo.blade.php ENDPATH**/ ?>