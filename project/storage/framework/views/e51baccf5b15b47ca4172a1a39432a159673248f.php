							...
							<div class="body-area">
								...
								<div class="gocover"
                                    ...
                                    <div class="row" id="">
										...
										<div class="col-lg-12">
											<input name="weght" type="number" value="1" required class="input-field" placeholder="<?php echo e(__('e.g 5')); ?>" step="0.01" min="0.01">
													...
													<div class="size-area">
														...
														<div class="row">
															<div class="col-md-4 col-sm-6">
																...
																<input type="text" oninput="this.value = this.value.replace(/[,]/g, '').replace(/(\..*?)\..*/g, '$1');" name="size[]" class="input-field"
																  id="size_name"	placeholder="<?php echo e(__('Size Name')); ?>">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>
																...
																<input type="number" name="size_qty[]" class="input-field"
																	placeholder="<?php echo e(__('Size Qty')); ?>" value="0" min="0" id="size_qty">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>
																...
																<input type="number" name="size_price[]" class="input-field"
																 id="size_price"	placeholder="<?php echo e(__('Size Price')); ?>" value="0" min="0">
															</div>
														</div>
													</div>
												</div>
...
if ($('#size-check').is(':checked')) {
   ...
   $(".unrequire").attr('required', 'required');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\upwork_first\project\resources\views/admin/product/create/physical.blade.php ENDPATH**/ ?>