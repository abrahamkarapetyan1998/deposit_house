...
class DsslController extends Controller
{
    public function store(Request $request){
        ...
        if($curr->name != "BDT")
        {
            return redirect()->back()->with('unsuccess',__('Please Select BDT Currency For SSLCommerz.'));
        }
 ...
 public function cancle(Request $request){
    return redirect()->route('user-deposit-create')->with('unsuccess',__('Payment Cancelled.'));
 }
    ...
    public function notify(Request $request){
        ...
        if($input['status'] == 'VALID'){
            ...
            else
            {
                ...
                mail($user->email,__('Balance has been added to your account. Your current balance is: $') . $user->balance, $headers);
            }
