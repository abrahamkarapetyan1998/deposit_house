...
class InstamojoController extends Controller
{
 ...
 public function store(Request $request){
        ...
        if(Session::has('currency')){
            ...
            if($curr->name != "INR")
            {
                return redirect()->back()->with('unsuccess',__('Please Select INR Currency For Instamojo.'));
            }
...
$input = Session::get('user_data');
        ...
        else
        {
            ...
            mail($user->email,__('Your Vendor Account Activated','Your Vendor Account Activated Successfully. Please Login to your account and build your own shop.'),$headers);
        }
