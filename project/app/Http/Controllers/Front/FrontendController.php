...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
...

	{
        ...
        $sliders = DB::table('sliders')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->get();
...

    {
        ...
        $sideBanner = DB::table('side_banners')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->first();

        $services = DB::table('services')->where('user_id','=',0)->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->get();

        $bottom_small_banners = DB::table('banners')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->where('type','=','BottomSmall')->get();

        $large_banners = DB::table('banners')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->where('type','=','Large')->get();

        $top_small_banners = DB::table('banners')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->where('type','=','TopSmall')->get();
        ...
        return view('front.extraindex',compact('ps','services','reviews','large_banners','bottom_small_banners','best_products','top_products','hot_products','latest_products','big_products','trending_products','sale_products','discount_products','partners','top_small_banners','feature_products','sideBanner'));
...
// CURRENCY SECTION ENDS
    ...
    public function autosearch($slug,Request $request)

    {
        ...
        if(mb_strlen($slug,'utf-8') > 1){
            ...
            $array=$this->generateSearchWords($search);
            ...
            if (!empty($slug)) {
                ...
                if(Category::where('slug', $request->category_id)->first()){
            ...
            $prods = Product::when($search, function ($query2, $search) use ($array) {





                $query2->where(function($query) use ($search,$array) {



                    $query->Where(function ($q) use ($array) {

                        foreach ($array as $ar) {

                            if ($ar) {

                                $q->orwhere('name', 'like', '%' . $ar . '%');
                    ...
                    $query->orWhere(function ($q) use ($array) {

                        foreach ($array as $ar) {

                            if ($ar) {

                                $q->orwhere('tags', 'like', '%' . $ar . '%');
                ...
                })->where('status','=',1)->orderBy('id', 'DESC')->take(10)->get()->reject(function($item){
...
// -------------------------------- BLOG SECTION ----------------------------------------
...

	{
		...
		$blogs = Blog::whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->orderBy('created_at','desc')->paginate(9);
...

    {
        ...
        $blogs = $bcat->blogs()->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->orderBy('created_at','desc')->paginate(9);
...

    {
        ...
        $blogs = Blog::where('tags', 'like', '%' . $slug . '%')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->paginate(9);
...

    {
        ...
        $blogs = Blog::where('title', 'like', '%' . $search . '%')->orWhere('details', 'like', '%' . $search . '%')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->paginate(9);
...

    {
        ...
        $blogs = Blog::where('created_at', 'like', '%' . $date . '%')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->paginate(9);
...

    {
        ...
        $archives= Blog::whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->orderBy('created_at','desc')->get()->groupBy(function($item){ return $item->created_at->format('F Y'); })->take(5)->toArray();
...
// -------------------------------- FAQ SECTION ----------------------------------------
...

	{
        ...
        $faqs =  DB::table('faqs')->orderBy('id','desc')->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->get();
...
// -------------------------------- PAGE SECTION ----------------------------------------
...

    {
        ...
        $page =  DB::table('pages')->where('slug',$slug)->whereLanguageId(Session::has('language') ? Session::get('language') : Language::whereIsDefault(1)->first()->id)->first();
...
// -------------------------------- CONTACT SECTION ----------------------------------------
...

    {
        ...
        if(Session::has('language')){
            ...
            $contact_language = json_decode($gs->contact_langauge,true);

            $contact_success = $contact_language[$language]['contact_success'];
        ...
        return response()->json($contact_success);
