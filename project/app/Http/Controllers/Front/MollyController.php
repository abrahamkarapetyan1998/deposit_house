...
public function store(Request $request){
    ...
    if (Session::has('currency')) 
            ...
            if($curr->name != "USD")
            {
                return redirect()->back()->with('unsuccess',__('Please Select USD Currency For Mollie.'));
            }
...
public function notify(Request $request){
    if (Session::has('currency')) 
        ...
        else
        {
           ...
           $msg = __("Hello ").$paypal_data['name'].__("!\nYou have placed a new order.\nYour order number is ").$molly_data['item_number'].__(".Please wait for your delivery. \nThank you.");
        ...
        if($gs->is_smtp == 1)
        {
            $data = [
                ...
                'body' => __("Hello Admin!<br>Your store has received a new order.<br>Order Number is ").$molly_data['item_number'].__(".Please login to your panel to check. <br>Thank you."),
            ];
        ...
        else
        {
           $to = Pagesetting::find(1)->contact_email;
           $subject = __("New Order Recieved!!");
           $msg = __("Hello Admin!\nYour store has recieved a new order.\nOrder Number is ").$molly_data['item_number'].__(".Please login to your panel to check. \nThank you.");
            $headers = "From: ".$gs->from_name."<".$gs->from_email.">";
           mail($to,$subject,$msg,$headers);
        }
