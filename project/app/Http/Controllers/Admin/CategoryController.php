...
class CategoryController extends Controller
{
    ...
    {
        $categoriess = Category::orderby('serial','asc')->get();
        return view('admin.category.dragdrop',compact('categoriess'));
    }

    public function dragdropSubmit(Request $request)
    {
       foreach($request->sort as $key => $id){
