...
Route::prefix('admin')->group(function() {
    ...
    Route::get('foo', function () {
        Product::whereHas('productUser', function ($query) {
            $query->where(function($query) {
                $query->where('is_vendor', '<', 2);
            });
        })->take(10)->with('productUser')->get()->dd();
    });
  //------------ ADMIN LOGIN SECTION ------------
  ...
  //------------ ADMIN WITHDRAW METHOD SECTION START ------------

  Route::get('withdraw/method/datatables','Admin\WithdrawMethodController@datatables')->name('admin-withdraw-method-datatables');

  Route::get('withdraw/methods','Admin\WithdrawMethodController@index')->name('admin-withdraw-method-index');

  Route::get('withdraw/methods/create','Admin\WithdrawMethodController@create')->name('admin-withdraw-method-create');

  Route::post('withdraw/methods/store','Admin\WithdrawMethodController@store')->name('admin-withdraw-method-store');

  Route::get('withdraw/methods/edit/{id}','Admin\WithdrawMethodController@edit')->name('admin-withdraw-method-edit');

  Route::post('withdraw/methods/update/{id}','Admin\WithdrawMethodController@update')->name('admin-withdraw-method-update');

  Route::get('withdraw/methods/delete/{id}','Admin\WithdrawMethodController@delete')->name('admin-withdraw-method-delete');

  Route::get('withdraw/methods/status/{id}/{status}','Admin\WithdrawMethodController@status')->name('admin-withdraw-method-status');

  //------------ ADMIN WITHDRAW METHOD SECTION END ------------
  ...
  Route::group(['middleware'=>'permissions:dashboard'],function(){
  ...
  Route::get('/dashboard', 'Admin\DashboardController@staffDashboard')->name('admin.staff.dashboard');
  ...
  Route::get('/orders/{slug}', 'Admin\OrderController@index')->name('admin-order-index');
...
// Verification Section Ends
  ...
  Route::get('/category/serial/manage', 'Admin\CategoryController@dragdrop')->name('admin-category-serial-index');

  Route::post('/category/serial/submit', 'Admin\CategoryController@dragdropSubmit')->name('admin-category-sort-submit');
...
//------------ ADMIN PACKAGE -----------------
  ...
  Route::get('/general-settings/istrams/{status}', 'Admin\GeneralSettingController@istrmas')->name('admin-gs-istrmas');
  ...
  Route::post('/pagesetting/sidebanner/submit','Admin\PageSettingController@sideBannerSubmit')->name('admin-ps-sidebanner-submit');
...
//------------ ADMIN MENU PAGE SETTINGS SECTION ENDS ------------
  ...
  Route::get('/is_sms/{status}', 'Admin\GeneralSettingController@is_sms')->name('admin-gs-is_sms');

  Route::get('/is_sms_verification/{status}', 'Admin\GeneralSettingController@sms_verification')->name('admin-gs-is_sms_verification');
  ...
  Route::get('/sms-templates/datatables', 'Admin\SmsController@datatables')->name('admin-sms-datatables');

  Route::get('/sms-templates', 'Admin\SmsController@index')->name('admin-sms-index');

  Route::get('/sms-templates/{id}', 'Admin\SmsController@edit')->name('admin-sms-edit');

  Route::post('/sms-templates/{id}', 'Admin\SmsController@update')->name('admin-sms-update');
...
// Payment Informations
  ...
  Route::get('/general-settings/cpay/{status}', 'Admin\GeneralSettingController@cpay')->name('admin-gs-cpay');
...
// Currency Settings
  ...
  Route::get('/products/popular','Admin\SeoToolController@popular')->name('admin-prod-popular');
...
Route::prefix('user')->group(function() {
  ...
  Route::get('/register/otp/verify/{email}', 'User\RegisterController@otp_verify')->name('user-verify-otp');

  Route::post('/register/otp/verify/submit', 'User\RegisterController@otp_verify_submit')->name('user-otp-verify-submit');

  Route::get('/register/otp/verify/resend/{email}', 'User\RegisterController@otp_verify_resend')->name('user.otp.verify.resend');
...
Route::prefix('vendor')->group(function() {
  ...
  Route::get('/login', 'User\LoginController@vendorshowLoginForm')->name('vendor.login');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::post('/cpay/payment/submit', 'Front\CpayController@store')->name('cpay.payment.submit');

  Route::post('/cpay/payment/success', 'Front\CpayController@success')->name('cpay.payment.success');

  Route::post('/cpay/payment/cancel', 'Front\CpayController@cancel')->name('cpay.payment.cancel');

  Route::get('/cpay/payment/success', 'Front\CpayController@success')->name('cpay.payment.success');

  Route::get('/cpay/payment/cancel', 'Front\CpayController@cancel')->name('cpay.payment.cancel');
