                            ...
                            <div class="xzoom-container">
                                ...
                                <div class="xzoom-thumbs">
                                    ...
                                    <div class="all-slider">
                                        ...
                                        <a class="gallery_mobile" href="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:asset('assets/images/products/'.$productt->photo)}}">
                                        ...
                                        @foreach($productt->galleries as $gal)
                                            <a class="gallery_mobile" href="{{asset('assets/images/galleries/'.$gal->photo)}}">
                                            ...
                                            @if($productt->product_condition != 0)
                                                <li>
                                                    <div class="{{ $productt->product_condition == 2 ? 'mybadge' : 'mybadge1' }}">
                                                        {{ $productt->product_condition == 2 ?$langg->new : $langg->used }}
                                                    </div>
                                                </li>
                                            @endif
                                        </ul>
                                        ...
                                        <div class="product-size">
                                            ...
                                            <ul class="siz-list">
                                                ...
                                                @foreach($productt->size as $key => $data1)
                                                    ...
                                                    <li class="{{ $is_first ? 'active' : '' }} @if(!isset($productt->size_qty[$key]) || $productt->size_qty[$key] == 0) disabled @endif">
                        <span class="box">{{ $data1 }}
                          <input type="hidden"  class="size" value="{{ $data1 }}">
                          <input type="hidden" class="size_qty" value="{{ $productt->size_qty[$key]??0 }}">
                          <input type="hidden" class="size_key" value="{{$key}}">
                          <input type="hidden" class="size_price"
                                 value="{{ round(($productt->size_price[$key]??0) * $curr->value,2) }}">
                        </span>
                                                    </li>
                                                    @php
                                                        $is_first = false;
                                                            ...
                                                            @if (array_key_exists("details_status",$attrVal) && $attrVal['details_status'] == 1)
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group mb-2">
                                                                        <strong for="" class="text-capitalize">{{ $attrVal['name'] }} :</strong>
                                                                        <div class="">
                ...
                @if($gs->reg_vendor == 1)
                    <div class="col-lg-3">
                        ...
                        <div class="seller-info mt-3">
                            ...
                            @if( $productt->user_id  != 0)
                                <a href="{{ route('front.vendor',$productt->user->shop_slug) }}" class="view-stor">{{ $langg->lang249 }}</a>
                            @endif
