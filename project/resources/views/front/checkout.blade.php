			...
			{{ csrf_field() }}
					...
					<div class="checkout-area">
						...
						<div class="tab-content" id="pills-tabContent">
										...
										<div class="order-area">
											...
											<div class="row p-5">
												...
												<div class="col-md-6">
													...
													@if ($shipping_weghts[$key]['weght'] != 0)
												...
												<div class="row">
													...
													<div class="col-lg-12">
														...
														@if($gs->cpay_check == 1)
															...
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('cpay.payment.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'cpay','slug2' => 0]) }}" id="v-pills-tab21-tab" data-toggle="pill" href="#v-pills-tab21" role="tab" aria-controls="v-pills-tab21" aria-selected="false">
                            ...
                            <input type="hidden" id="shipping-cost" name="shipping_cost" value="{{$shipping_total_cost}}">
                            ...
                            <input type="hidden" name="vendor_ship_ids" value="{{ $all_vendor_shipp }}">
