											...
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ $langg->lang431 }}</h5>
															...
															<li>
																<a target="_blank" href="{{ route('front.vendor',Auth::user()->shop_slug) }}"><i class="fas fa-eye"></i> {{ $langg->lang432 }}</a>
															</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="{{ route('front.vendor',Auth::user()->shop_slug) }}" class="wave-effect"><i class="fas fa-eye mr-2"></i> {{ $langg->lang440 }}</a>
							</li>
