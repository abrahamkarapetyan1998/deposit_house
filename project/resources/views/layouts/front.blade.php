								...
								<ul>
                        			...
                        			@if($gs->reg_vendor == 1)
										...
										<li>
											...
											<a href="{{route('vendor.login')}}" class="sell-btn">{{ $langg->lang220 }}</a>
				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					...
					<nav hidden>
						...
						<ul class="menu">
							...
							@foreach(DB::table('pages')->where('header','=',1)->whereLanguageId(Session::has('language') ? Session::get('language') : App\Models\Language::whereIsDefault(1)->first()->id)->get() as $data)
				...
				<div class="col-md-6 col-lg-4">
					...
					<div class="footer-widget info-link-widget">
						...
						<ul class="link-list">
							...
							@foreach(DB::table('pages')->where('footer','=',1)->whereLanguageId(Session::has('language') ? Session::get('language') : App\Models\Language::whereIsDefault(1)->first()->id)->get() as $data)
				...
				<div class="col-md-6 col-lg-4">
					...
					<div class="footer-widget recent-post-widget">
						...
						<ul class="post-list">
							...
							@foreach (App\Models\Blog::orderBy('created_at', 'desc')->whereLanguageId(Session::has('language') ? Session::get('language') : App\Models\Language::whereIsDefault(1)->first()->id)->limit(3)->get() as $blog)
					...
					<div class="col-lg-12">
							...
							<div class="content">
								...
								<div class="content text-center">
									...
									<p>@php echo $copyright_text @endphp</p>
						...
						<div class="tab-pane fade" id="nav-reg1" role="tabpanel" aria-labelledby="nav-reg-tab1">
							...
							<div class="login-area signup-area">
								...
								<div class="login-form signup-form">
									...
									<form class="mregisterform" data-is-vendor = "1" action="{{route('user-register-submit')}}"
