                        ...
                        @include('includes.admin.form-both')
                                              ...
                                              @endforeach
                                                ...
                                                <div class="row" id="">
													<div class="col-lg-12">
														<div class="left-area">
															<h4 class="heading">{{ __('Product Weght') }} (KG)*</h4>
														</div>
													</div>
													<div class="col-lg-12">
														<input name="weght" type="number" class="input-field" placeholder="{{ __('e.g 5') }}" required step="0.01" min="0.01" value="{{$data->weght}}">
													</div>
												</div>
																	 ...
																	 @foreach($data->size as $key => $data1)
																		...
																		<div  class="row">
																				<div class="col-md-4 col-sm-6">
																					...
																					<input type="text" name="size[]" oninput="this.value = this.value.replace(/[,]/g, '').replace(/(\..*?)\..*/g, '$1');" class="input-field" placeholder="Size Name" value="{{ $data->size[$key]??0 }}">
																				</div>
																				<div class="col-md-4 col-sm-6">
																						<label>
																							{{ __('Size Qty') }} :
																					...
																					<input type="number" name="size_qty[]" class="input-field" placeholder="Size Qty" min="0" value="{{ $data->size_qty[$key]??0 }}"  >
																				</div>
																				<div class="col-md-4 col-sm-6">
																						<label>
																							{{ __('Size Price') }} :
																					...
																					<input type="number" name="size_price[]" class="input-field" placeholder="{{ __('Size Price') }}" min="0" value="{{round(($data->size_price[$key]??0) * $sign->value , 2)}}">
																				</div>
																			</div>
																		</div>
																	 @endforeach
