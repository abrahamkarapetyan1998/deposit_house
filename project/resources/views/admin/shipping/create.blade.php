                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-shipping-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" step="0.01" class="input-field" name="form_weght" placeholder="{{ __('Form Weght') }}" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" step="0.01" class="input-field" name="to_weght" placeholder="{{ __('To Weght') }}" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="email" class="input-field" name="email" placeholder="{{ __('Shipper Email') }}" required="" value="">
                          </div>
                        </div>
