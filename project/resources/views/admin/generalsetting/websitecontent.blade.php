              ...
              <div class="add-product-content1">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    @php
                        $language_data = json_decode($gs->language,true);
                    @endphp
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">({{$language->language}}) {{ __('Website Title') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Write Your Site Title Here') }}" name="language[{{$language->id}}]" value="{{ isset($language_data["$language->id"]) ? $language_data["$language->id"] : '' }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                <h4 class="heading">
                                   {{ __('Accept Terms and Agreements') }}
                                </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_trams== 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-istrmas',1)}}" {{ $gs->is_trams == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-istrmas',0)}}" {{ $gs->is_trams == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                          ...
                          <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                <h4 class="heading">
                                    {{ __('Accept Terms and Agreements and Link') }} *
                                </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="tawk-area">
                                  <textarea  name="trams_link">{{$gs->trams_link}}</textarea>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                <h4 class="heading">
                                    {{ __('Invoice Footer Text') }} *
                                </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="tawk-area">
                                  <textarea  name="invoice_footer_text">{{$gs->invoice_footer_text}}</textarea>
                                </div>
                            </div>
                          </div>
