                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <th>{{ __("Total Product Sold") }}</th>
                                                            <td>{{ App\Models\VendorOrder::where('user_id','=',$data->id)->where('status','=','completed')->sum('qty') }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Total Withdraw") }}</th>
                                                            <td>{{ App\Models\Product::vendorConvertPrice(App\Models\Withdraw::whereUserId($data->id)->whereStatus('completed')->whereType('vendor')->sum('amount')) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Current Balance") }}</th>
                                                            <td>{{ App\Models\Product::vendorConvertPrice( App\Models\VendorOrder::where('user_id','=',$data->id)->where('status','=','completed')->sum('price')) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Total Earning") }}</th>
                                                            <td>{{ App\Models\Product::vendorConvertPrice($data->current_balance) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Pending Orders") }} : </th>
                                                            <td>{{ App\Models\VendorOrder::whereUserId($data->id)->whereStatus('pending')->count() }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Processing Orders") }} : </th>
                                                            <td>{{ App\Models\VendorOrder::whereUserId($data->id)->whereStatus('processing')->count() }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Completed Orders") }} : </th>
                                                            <td>{{ App\Models\VendorOrder::whereUserId($data->id)->whereStatus('completed')->count() }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>{{ __("Joined") }}</th>
