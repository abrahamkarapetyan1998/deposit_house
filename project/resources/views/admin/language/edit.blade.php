...
@section('content')
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-lang-update',$data->id)}}" novalidate method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                          ...
                          <div class="col-lg-10">
                            <nav>
                              <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-noti-tab" data-toggle="tab" href="#nav-noti" role="tab" aria-controls="nav-noti" aria-selected="false">{{ __('Notification Panel') }}</a>
                              </div>
                            </nav>
                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang15" placeholder="See All Categories" required="" value="{{$lang->lang15  ?? ""}}">
                          </div>
                        </div>
 ...
 <div class="tab-pane fade show text-center active" id="nav-noti" role="tabpanel" aria-labelledby="nav-noti-tab">
