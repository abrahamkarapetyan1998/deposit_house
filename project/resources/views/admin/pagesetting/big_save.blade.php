                ...
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="links">
                        ...
                        <li>
                          <a id="banner_url" href="{{ url()->current() }}">{{ __('Right Side Banner2') }} </a>
                        </li>
                      </ul>
                  </div>
                </div>
              ...
              <div class="add-product-content1">
                <div class="row">
                    ...
                    <div class="product-description">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->big_save_banner ? asset('assets/images/test/'.$data->big_save_banner):asset('assets/images/noimage.png') }});">
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->big_save_banner1 ? asset('assets/images/test/'.$data->big_save_banner1):asset('assets/images/noimage.png') }});">
                                    <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-7">
                      <input type="text" class="input-field" name="big_save_banner_link" placeholder="{{ __('Link') }}" required="" value="">
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-7">
                    <input type="text" class="input-field" name="big_save_banner_link1" placeholder="{{ __('Link') }}" required="" value="">
                  </div>
                </div>
                @endif
