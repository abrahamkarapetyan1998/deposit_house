                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        @php
                            $contact_data = json_decode($gs->contact_langauge,true);
                        @endphp
                        ...
                        @foreach (DB::table('languages')->get() as $language)
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class="nic-edit" name="contact_langauge[{{$language->id}}][contact_title]" > {{isset($contact_data["$language->id"]["contact_title"]) ? $contact_data["$language->id"]["contact_title"] : ''}}  </textarea>
                                  </div>
                              </div>
                            </div>
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class="nic-edit" name="contact_langauge[{{$language->id}}][contact_text]" > {{isset($contact_data["$language->id"]["contact_text"]) ? $contact_data["$language->id"]["contact_text"] : ''}}  </textarea>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea name="contact_langauge[{{$language->id}}][contact_success]" > {{isset($contact_data["$language->id"]["contact_success"]) ? $contact_data["$language->id"]["contact_success"] : ''}} </textarea>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea name="contact_langauge[{{$language->id}}][street]" placeholder="Enter Street Address"> {{isset($contact_data["$language->id"]["street"]) ? $contact_data["$language->id"]["street"] : ''}} </textarea>
                                  </div>
                              </div>
                            </div>
                            @endforeach
