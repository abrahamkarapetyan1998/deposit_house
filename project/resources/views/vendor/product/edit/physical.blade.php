								...
								@include('includes.vendor.form-both')
								  ...
								  @endforeach
		                            ...
		                            <div class="row" id="">
										...
										<div class="col-lg-12">
											<input name="weght" type="number" value="{{$data->weght}}" required class="input-field" placeholder="{{ __('e.g 5') }}" step="0.01" min="0.01">
														 ...
														 @foreach($data->size as $key => $data1)
															...
															<div  class="row">
																	<div class="col-md-4 col-sm-6">
																		...
																		<input type="text" name="size[]" oninput="this.value = this.value.replace(/[,]/g, '').replace(/(\..*?)\..*/g, '$1');" class="input-field" placeholder="{{ $langg->lang649 }}" value="{{ $data->size[$key] }}">
																	</div>
																	<div class="col-md-4 col-sm-6">
																			<label>
																				{{ $langg->lang651 }} :
																		...
																		<input type="number" name="size_qty[]" class="input-field" placeholder="{{ $langg->lang651 }}" min="1" value="{{ $data->size_qty[$key]??0 }}">
																	</div>
																	<div class="col-md-4 col-sm-6">
																			<label>
																				{{ $langg->lang653 }} :
																		...
																		<input type="number" name="size_price[]" class="input-field" placeholder="{{ $langg->lang653 }}" min="0" value="{{round(($data->size_price[$key]??0) * $sign->value , 2)}}">
																	</div>
																</div>
															</div>
														 @endforeach
