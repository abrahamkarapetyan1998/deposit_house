											...
											<form id="geniusform" action="{{ route('vendor-profile-update') }}" method="POST" enctype="multipart/form-data">
                      						 ...
                      						 @include('includes.vendor.form-both')  
													...
													<div class="col-lg-7">
														<div class="right-area">
																<h6 class="heading"> {{ $data->shop_name }}
																	...
																	@else
																	 <span class="verify-link"><a class="btn-primary btn-sm btn" href="{{ route('vendor-verify') }}">{{ $langg->lang784 }}</a></span>
																	@endif
																</h6>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="owner_name" placeholder="{{ $langg->lang458 }}" required="" value="{{$data->name}}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field"  placeholder="{{ $langg->lang459 }}" required="" value="{{$data->phone}}" disabled>
													</div>
												</div>
