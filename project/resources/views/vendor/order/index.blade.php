...
<input type="hidden" value="{{trans('search')}}" id="lang_search">
<input type="hidden" value="{{trans('show entries')}}" id="lang_entries">
<input type="hidden" value="{{trans('next page')}}" id="next">
<input type="hidden" value="{{trans('previous page')}}" id="previous">
