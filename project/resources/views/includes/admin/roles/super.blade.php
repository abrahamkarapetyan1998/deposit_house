<li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
            ...
            <li>
                <a href="{{route('admin-order-pending','pending')}}"> {{ __('Pending Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-processing','processing')}}"> {{ __('Processing Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-completed','completed')}}"> {{ __('Completed Orders') }}</a>
            </li>
            <li>
                <a href="{{route('admin-order-declined','declined')}}"> {{ __('Declined Orders') }}</a>
            </li>
    ...
    <li>
        <a href="{{ route('admin-country-index') }}" class=" wave-effect"><i class="fas fa-flag"></i>{{ __('Manage Country') }}</a>
    </li>
    <li>
    ...
    <li>
        ...
        @endif" id="menu5" data-parent="#accordion" >
                ...
                <li class="@if(request()->is('admin/category/serial/manage')) active @endif">
                    <a href="{{ route('admin-category-serial-index') }}"><span>{{ __('Drag & Drop Category') }}</span></a>
                </li>
        </ul>
    </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="sms" data-parent="#accordion">
            <li><a href="{{route('admin-sms-index')}}"><span>{{ __('SMS Template') }}</span></a></li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="payments" data-parent="#accordion">
            ...
            <li><a href="{{route('admin-withdraw-method-index')}}"><span>{{ __('Withdraw Method') }}</span></a></li>
