...
<div class="account-info">
                            ...
                            @include('includes.admin.form-error') 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="owner_name" value="{{$user->name}}" placeholder="{{ $langg->lang239 }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="shop_address" value="{{$user->shop_address}}" placeholder="{{ $langg->lang241 }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                    <input type="text" class="option" name="reg_number"  value="{{$user->reg_number}}" placeholder="{{ $langg->lang242 }}">
                                            </div>
                                        </div>
